...
import { getSubject } from "@/actions/quiz.actions";
...
export function QuizChart({
  ...
  return (
    <Card>
      <CardHeader>
        <CardTitle>Student Quizzes</CardTitle>
        <CardDescription>
          Select a date range to view the number of quizzes taken by the student
        </CardDescription>
      </CardHeader>
        ...
        <ChartContainer config={chartConfig} className="max-h-[25rem] w-full">
          ...
          >
            ...
            <XAxis
              ...
              axisLine={false}
              tickMargin={8}
              tickFormatter={(value) => value.slice(4, 11)}
            />
            <YAxis
              tickLine={false}
              axisLine={false}
